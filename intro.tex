...
\lnote{<- se alla fine non inseriamo le nuove annotazioni, questa parte non so se lasciarla. possiamo riscriverla in funzione del paragrafo successivo? -- V: per ora lasciamo poi in base a come vanno gli esperimenti sul dota originale vs riannotato, che dici?}  
