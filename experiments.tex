...
\end{tabular}
	\end{center}
	\caption{Study the effect on training of the number of frames per video. Row \#2 is NF 3 of previous experiment in Fig.~\ref{fig:num-frames-vst}.}
...
In Fig.~\ref{fig:num-memory-cells}, we compare the network with and without the long-term memory.
