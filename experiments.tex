...
\begin{figure}[b!]
\centerline{\includegraphics[clip,width=0.6\columnwidth]{images/exp_1.jpg}}
...
\begin{figure}[b!]
\centerline{\includegraphics[clip,width=0.6\columnwidth]{images/exp_2.jpg}}
...
\begin{figure}[t!]
\centerline{\includegraphics[clip,width=0.6\columnwidth]{images/exp_3.jpg}}
    \caption{Performance comparison, changing the video clip length (from 4 to 16). The "8 frames" configuration corresponds to NF 3 in Fig.~\ref{fig:num-frames-vst}.\vspace{-2mm}\label{fig:random-batch}}
\end{figure}
