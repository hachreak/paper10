...
\end{tabular}
	\end{center}
	\caption{Study the effect on training of the video clip length. Row \#2 is NF 3 of previous experiment in Fig.~\ref{fig:num-frames-vst}.}
...
\end{tabular}
	\end{center}
	\caption{Detection accuracy for each individual accident category (AUC) on VAD task. "*" indicates non-ego anomaly categories. \lnote{mettiamo tutte le classi?}}
...
In Table \ref{tab:random-batch}, we evaluate the effect of the size of the video clip length.
