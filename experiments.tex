...
On the contrary, with 4 frames we have the highest AUC.
...
Table \ref{tab:sota-vad-auc-per-class} shows results per class \tnote{gli acronimi delle classi cosa rappresentano?}.
