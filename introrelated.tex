...
%Moreover, if a V2V (vehicles to vehicles) \cite{fatemidokht2021efficient} network infrastructure is available, dissemination of useful information can provide other connected vehicles insights about the traffic status.
...
It is worth noting that our model works in a more restrictive scenario than most of other models, adding a further degree of difficulty given by the real time guaranteed response times and online capabilities.\mnote{con il guaranteed mi sembra si stressi ancora di piú il real time!}